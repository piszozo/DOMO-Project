...
unlocked to sign the Heptacoin-Qt.app bundle.
...
allowing somebody to distribute a Heptacoin-Qt.app or heptacoin-qt-setup.exe with a valid
...
that the heptacoin-qt.exe file inside the installer had not been tampered with.
