...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid heptacoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid heptacoin address" in e.error['message'])
